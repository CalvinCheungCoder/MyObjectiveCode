...
static DHFMDB *dhdb = nil;
+ (instancetype)shareDatabase
{
    if (!dhdb) {
        [DHFMDB shareDatabase:nil];
    }
    return dhdb;
}
...
{
    return [DHFMDB shareDatabase:dbName path:nil];
}
...
{
    return [self dh_createTable:tableName dicOrModel:parameters excludeName:nil];
}
